        ...
        <section className="text-gray-700 body-font overflow-hidden bg-white">
            <div className="container px-5 py-10 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt={title}
                         className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200 h-[395px]"
                         src={image}
                    />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex mt-5">
                            ...
                            <button
                                ...
                                className="flex ml-auto text-white bg-cyan-600 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-800 rounded">
                                Add to cart
                            </button>
                            <button
